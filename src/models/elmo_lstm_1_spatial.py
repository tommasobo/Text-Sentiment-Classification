...
def run_model(args, input_obj):
    ...
    previous_out = layers.LSTM(units=1024, return_sequences=True)(previous_out)
    previous_out = layers.LSTM(units=512)(previous_out)
    previous_out = layers.Dense(64, activation='relu')(previous_out)
