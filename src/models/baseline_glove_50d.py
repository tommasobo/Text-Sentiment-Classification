...
def run_model(args, input_data):
    if args.glove_model == constants.GLOVE_PRETRAINED_TWEETS:
        with open(constants.PRETRAINED_GLOVE_EMBEDDING_50, 'r', encoding="utf8") as f:
            vocab = dict()
            em = np.zeros((1193513, EMBEDDING_DIM)) # magic number is vocab size
            ...
            expected_size = EMBEDDING_DIM + 1 # + 1 as the inital token is the symbol in question
        ...
        em_fp = constants.GLOVE_EMBEDDING_50
