...
def run_model(args, input_obj):
    ...
    # Defining Model - Not Effective, max 85-86% accuracy
    ...
    previous_out = layers.Bidirectional(layers.GRU(units=512, return_sequences=True, dropout = 0.2))(previous_out)
    previous_out = layers.Bidirectional(layers.GRU(units=256, return_sequences=True, dropout = 0.2))(previous_out)
