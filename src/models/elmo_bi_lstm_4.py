...
def run_model(args, input_obj):
    ...
    previous_out = layers.Bidirectional(layers.LSTM(units=1024, return_sequences=True, dropout = 0.2))(previous_out)
    previous_out = layers.Bidirectional(layers.LSTM(units=256, return_sequences=True, dropout = 0.2))(previous_out)
    previous_out = layers.Bidirectional(layers.LSTM(units=64, dropout = 0.2))(previous_out)
