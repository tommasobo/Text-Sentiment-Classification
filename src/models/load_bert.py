# To be used to continue training a saved Bert Model. Not for external use.
import csv
import sys
import os
import argparse
...
def run_model(args, input_data, load_path):
    ...
    model = load_model(load_path, custom_objects=get_custom_objects())
