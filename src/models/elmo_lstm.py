...
def run_model(args, input_obj):
    ...
    previous_out = layers.LSTM(units=256, return_sequences=True, recurrent_dropout=0.2, dropout = 0.2)(previous_out)
    previous_out = layers.LSTM(units=128, return_sequences=True, recurrent_dropout=0.2, dropout = 0.2)(previous_out)
